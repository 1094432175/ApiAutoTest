...
#注册接口
url = "http://192.168.150.54:8089/futureloan/mvc/api/member/register?mobilephone=13821111111&pwd=12356&regname=阿西吧"
r = requests.get(url)
r = r.json()
print(r)
assert r['status'] == 0
...
url = "https://tcc.taobao.com/cc/json/mobile_tel_segment.htm?tel=17795771761"
r = requests.get(url)
print(r.text)
print(type(r))
