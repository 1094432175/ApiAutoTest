...
def test_001():
    ...
    canshu = {"订单号":"12345","支付金额": 20.56,"支付方式":"支付宝/微信/余额宝/银行卡"}
    r = pay.zhifu(canshu)
    print(r)
    assert r['msg'] == "支付成功"
...
def test_003(a): #a 表示test_001.Pay.zhifu
    pay = Pay()
    #可以在这里模拟接口的返回值,也可以在@mock.patch中模拟接口的返回值
    a.return_value = {"code": 205,"msg": "支付超时"}
...
def test_withdraw():
    canshu = {"mobilephone":"18012345678","amount":100}
